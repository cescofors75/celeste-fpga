...
module celeste_cellular_lab_board(
 ...
 stream_endpoint #(.DEPTH(16),.DSP(1),.SDRAM(0),.LINE_IN(4)) endpoint(clk_audio,ar[2],ep_rx_valid,ep_rx_data,ep_rx_ready,ep_tx_valid,ep_tx_data,ep_tx_ready,pcm_bck,pcm_lrck,pcm_din,monitor_valid,monitor_left,
