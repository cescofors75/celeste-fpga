...
set out [file join $root build feedback-lab]
file mkdir $out
cd $out
set_device -name GW2AR-18C GW2AR-LV18QN88C8/I7
foreach src {audio/sample_fifo.sv audio/sdram_fifo.sv audio/async_fifo.sv audio/i2s_tx.v top/stream_audio.sv control/protocol_rx.sv control/stream_endpoint.sv control/uart_8n1.sv audio/i2s_rx_master.sv top/line_in_master_audio.sv audio/audio_mailbox.sv audio/i2s_slave.sv top/line_in_audio.sv top/celeste_feedback_lab_board.sv} {add_file -type verilog [file join $root fpga rtl $src]}
...
set_option -top_module celeste_feedback_lab_board
set_option -output_base_name celeste_feedback_lab
